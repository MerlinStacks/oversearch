...
class Overseek_Search_Analytics_Controller {
	...
	/**
	 * Get shared route arg schema for day windows.
	 *
	 * @return array
	 */
	private function get_days_arg() {
		return array(
			'type'              => 'integer',
			'default'           => 30,
			'sanitize_callback' => 'absint',
	...
	/**
	 * Get shared route arg schema for list limits.
	 *
	 * @return array
	 */
	private function get_limit_arg() {
		return array(
			'type'              => 'integer',
			'default'           => 20,
			'sanitize_callback' => 'absint',
	...
	/**
	 * Get cutoff date string for a day window.
	 *
	...
	public function track_event( $request ) {
		...
		$wpdb->insert(
			...
			array(
				...
				'session_id'         => $request->get_param( 'session_id' ) ? $request->get_param( 'session_id' ) : '',
	...
	public function get_summary( $request ) {
		...
		$table = Overseek_Search_Database::get_analytics_table();
		$date  = $this->get_cutoff_date( $days );
