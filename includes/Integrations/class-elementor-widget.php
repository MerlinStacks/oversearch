...
class Overseek_Elementor_Widget extends \Elementor\Widget_Base
{
    ...
    protected function render()
    {
        ...
        $shortcode_atts = array(
            ...
            'show_voice' => $settings['show_voice'] === 'yes' ? 'true' : 'false',
        );
 ...
 */
function overseek_register_elementor_widget($widgets_manager)
{
    $widgets_manager->register(new Overseek_Elementor_Widget());
}

add_action('elementor/widgets/register', 'overseek_register_elementor_widget');
