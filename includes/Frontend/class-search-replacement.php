...
class Overseek_Search_Replacement {
	...
	/**
	 * Intercept native product search requests.
	 *
	 * Intentionally a no-op: this hook exists to prevent callback errors and
	 * to keep search handling centralized via localized initial query state.
	 *
	 * @return void
	 */
	public function intercept_search_redirect() {
		...
		// No redirect needed. Frontend reads the query and opens OverSeek UI.
	}
