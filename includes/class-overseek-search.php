...
class Overseek_Search
{
    ...
    private function load_dependencies()
    {
        ...
        require_once OVERSEEK_SEARCH_PLUGIN_DIR . 'includes/Search/class-spell-checker.php';
        ...
        require_once OVERSEEK_SEARCH_PLUGIN_DIR . 'includes/API/class-boosts-controller.php';
        ...
        // Integration classes (conditionally loaded).
        require_once OVERSEEK_SEARCH_PLUGIN_DIR . 'includes/Integrations/class-elementor-widget.php';
        require_once OVERSEEK_SEARCH_PLUGIN_DIR . 'includes/Integrations/class-gutenberg-block.php';
        require_once OVERSEEK_SEARCH_PLUGIN_DIR . 'includes/Integrations/class-multilingual-support.php';
    ...
    private function define_api_hooks()
    {
        ...
        $boosts_controller = new Overseek_Boosts_Controller();
        ...
        $this->loader->add_action('rest_api_init', $boosts_controller, 'register_routes');
    }
